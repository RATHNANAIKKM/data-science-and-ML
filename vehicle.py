...
while True:
    ...
    dilatada = cv2.morphologyEx(dilat,cv2.MORPH_CLOSE, (5,5))
    dilatada = cv2.morphologyEx(dilatada,cv2.MORPH_CLOSE, (5,5))
    countershape,h = cv2.findContours(dilatada,cv2.RETR_TREE,cv2.CHAIN_APPROX_SIMPLE)

    cv2.line(framel,(25,count_line_position),(1200,count_line_position),(255,127,0),3)
    ...
    for (i,c) in enumerate(countershape):
        ...
        cv2.circle(framel,center,4,(0,255,0),-1)
